...
#: ${_CATKIN_SETUP_DIR:=/home/srstest3/RETINA_Analyzer_ROS1208/catkin_ws/install}
: ${_CATKIN_SETUP_DIR:=/home/eddi/radar-dev/install}
...
CATKIN_SHELL=sudo $CATKIN_SHELL "$_SETUP_UTIL" $@ ${CATKIN_SETUP_UTIL_ARGS:-} >> "$_SETUP_TMP"
_RC=$?
if [ $_RC -ne 0 ]; then
  if [ $_RC -eq 2 ]; then
